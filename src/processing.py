def filter_by_state(dicts_list: list[dict[str, str | int ]], state="EXECUTED") -> list[dict[str, str | int ]]:
...
def sort_by_date(dicts_list: list[dict[str, str | int ]], reverse=True) -> list[dict[str, str | int ]]:
